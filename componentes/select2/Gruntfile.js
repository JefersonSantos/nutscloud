module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      'dist': {
        ...
        src: [
          'bibliotecas/js/select2.js',
          'src/js/wrapper.end.js'
        ],
        dest: 'bibliotecas/js/select2.js'
      },
      'dist.full': {
        options: {
          banner: grunt.file.read('src/js/wrapper.start.js'),
        ...
        src: [
          'bibliotecas/js/select2.full.js',
          'src/js/wrapper.end.js'
        ],
        dest: 'bibliotecas/js/select2.full.js'
      }
    },
    ...
    uglify: {
      'dist': {
        src: 'bibliotecas/js/select2.js',
        dest: 'bibliotecas/js/select2.min.js',
        options: {
          banner: minifiedBanner
        }
      },
      'dist.full': {
        src: 'bibliotecas/js/select2.full.js',
        dest: 'bibliotecas/js/select2.full.min.js',
        options: {
          banner: minifiedBanner
        }
      }
    ...
    requirejs: {
      ...
      'dist.full': {
        options: {
          ...
          optimize: 'none',
          name: 'select2/core',
          out: 'bibliotecas/js/select2.full.js',
  ...
  grunt.registerTask('compile', [
    'requirejs:bibliotecas', 'requirejs:bibliotecas.full', 'requirejs:i18n',
    'concat:bibliotecas', 'concat:bibliotecas.full',
    'sass:dev'
  ]);
  grunt.registerTask('minify', ['uglify', 'sass:bibliotecas']);
